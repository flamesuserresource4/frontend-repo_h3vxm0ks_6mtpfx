      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 py-20">
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="mt-3 text-neutral-600">“Za dostupnost i rezervacije, pošaljite poruku”</p>
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="flex items-center gap-3 text-neutral-700">
                ...
                <span>viladjuricpetrovac@gmail.com</span>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={(e) => e.preventDefault()} className="rounded-2xl border border-neutral-200 bg-[#f7f3ee] p-6 shadow-sm">
              <div className="grid grid-cols-1 gap-4">
                <div>
                  ...
                  <input type="text" className="mt-1 w-full rounded-xl border border-neutral-300 bg-white px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#c7a86f]/40" placeholder="Your name" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea rows="5" className="mt-1 w-full rounded-xl border border-neutral-300 bg-white px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#c7a86f]/40" placeholder="Your message" />
                </div>
                <button className="mt-2 inline-flex items-center justify-center rounded-full bg-[#c7a86f] text-white px-6 py-3 shadow hover:shadow-md transition-shadow">Send Inquiry</button>
              </div>
            </form>
          </div>
        </div>
